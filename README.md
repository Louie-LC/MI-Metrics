# MI-Metrics
MI-Metrics is an application created to store test restuls generated by molecular imaging systems. The front end is coded in C# and WPF / XAML, the back end was created using Microsoft SQL server.
